...
namespace RSELFANG.DAO
{
    public class DAOSfForpo
    {
        ...
        public List<SfForpo> GetModVi(int emp_codi)
        {
            StringBuilder sql = new StringBuilder();
            sql.Append(" SELECT SF_MODVI.MOD_CONT,SF_MODVI.MOD_NOMB,SF_TCONV.TCO_CODI,SF_TCONV.TCO_NOMB ");
        ...
        public sfmodvi getInfoModvi(int emp_codi, string mod_cont)
        {
            StringBuilder sql = new StringBuilder();
            ...
            return new DbConnection().Get<sfmodvi>(sql.ToString(), sqlparams);
        }
