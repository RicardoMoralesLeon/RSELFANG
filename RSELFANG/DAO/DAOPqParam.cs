...
namespace RSELFANG.DAO
{
    public class DAOPqParam
    {
        ...
        public TOPqParam GetMailParam(int emp_codi = 0)
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("  SELECT  PAR_URLE,PAR_MCIN,PAR_TCIN,PAR_MCTR,PAR_TCTR,PAR_MCCR,PAR_TCCR, PAR_ASUI, REL_CONT FROM PQ_PARAM,GN_TERCE ");
        ...
        {            
            ...
            rel_cont = reader["REL_CONT"].AsInt()
        };
    }
}